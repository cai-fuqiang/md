...
```
## PC=90000000015d3f40 SP=90000001003cf6d0
## 90000000015d3f40:type:call sp:sp +  48 fp: (und)  ra:prevsp +  -8 signal:0
## 90000000015d3f40 <queued_spin_lock_slowpath+600>: ldptr.w         $t0, $s0, 0
...
## SP=90000001003cf700 IP=$(90000001003cf6f8)
## 9000000000224700: type:call sp:sp +  48 fp: (und)  ra:prevsp +  -8 signal:0
## 9000000000224704: <die+284>:   bl queued_spin_lock_slowpath
...
## SP=90000001003cf730 IP=$(90000001003cf728)
## 90000000015d4b3c <do_page_fault+84>
## 90000000015d4b04: type:call sp:sp +  48 fp: (und)  ra:prevsp +  -8 signal:0
...
## SP=90000001003cf760 IP=$(90000001003cf758)
## 900000000023b2a0 <tlb_do_page_fault_0+280>
## 900000000023b188: type:? sp: (und)  fp: (und)  ra: (und)  signal:0
## 900000000023b23c:type:regs sp:sp +   0 fp: (und)  ra: (und)  signal:0
90000001003cf758:  900000000023b2a0   .cS.......#.....
