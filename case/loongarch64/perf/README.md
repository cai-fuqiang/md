...
> NOTE
>
> 这个地方我测试的有问题，物理机中测试并未跨numa，而虚拟机测试的时候，并未绑定numa亲核，所以
> 虚拟机测试时，跨numa损耗大。

当使用guest不跨numa 或者  1:1绑核时, 虚拟化损耗单核在7%，多核在25%。使用1:1 绑核
和不跨numa 测试结果类似。

#### 优化UNIXBENCH 虚拟机跑分

和龙芯同学交流，其建议打开pv-ipi 再次测试。qemu合入pvipi feature。并在xml中开启半虚拟化，
并未有性能提升。
